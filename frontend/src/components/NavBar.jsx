        ...
        <div className="flex sticky justify-between items-center text-white top-0 left-0 z-50">
            ...
            <div>
                <ul className="flex justify-center items-center list-none space-x-5 p-3 bg-blue-500/20 rounded-2xl">
                    <li className='hover:text-blue-400 font-semibold'><Link to="/" className='text-blue-400 font-semibold'>Home</Link></li>
                    <li className='hover:text-blue-400 font-semibold '><Link>Categories</Link></li>
                    <li className='hover:text-blue-400 font-semibold'><Link>Search</Link></li>
                    <li className='hover:text-blue-400 font-semibold'><Link>Support</Link></li>
                </ul>
            </div>
            {/* Cart and profile */}
            <div>

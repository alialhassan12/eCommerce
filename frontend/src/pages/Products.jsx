                    ...
                    <div data-aos="fade-down" className="space-y-10 " >
                        ...
                        <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                            {products.products.map((product) => (
                                <Link key={product._id} to={`/category/${categoryId}/${product._id}`}  className="group cursor-pointer ">
                                    <img
                                        src={product.photos[0]}
                                        className="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-7/8 transition duration-200"
                                    />
